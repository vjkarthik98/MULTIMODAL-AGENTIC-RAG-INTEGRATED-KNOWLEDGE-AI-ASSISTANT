...
Logged params: git_sha, dataset_version, embedding_model, reranker_model,
               judge_model, top_k, hybrid_weights, mmr_lambda.
...
def log_eval_run(
    ...
    with mlflow.start_run() as run:
        ...
        try:
            ...
            mlflow.log_param("top_k", getattr(s, "DEFAULT_TOP_K", getattr(s, "RAG_TOP_K", "unknown")))
