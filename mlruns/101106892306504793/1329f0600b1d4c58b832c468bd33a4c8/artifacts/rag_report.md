...
**Generated:** 2026-05-26T01:45:28Z  
**Git SHA:** aa4da29  
...
| `generation.answer_relevancy` | 0.3075 | 14 | judge=lexical_fallback (ragas_error: Can't instantiate abstr |
| `generation.citation_accuracy` | 1.0000 | 9 | judge=lexical_fallback (ragas_error: Can't instantiate abstr |
| `generation.context_recall` | 0.4926 | 14 | judge=lexical_fallback (ragas_error: Can't instantiate abstr |
| `generation.faithfulness` | 0.5114 | 14 | judge=lexical_fallback (ragas_error: Can't instantiate abstr |
| `generation.generation_p50_sec` | 12.6743 | 14 | min=6.03s max=32.97s |
| `generation.generation_p95_sec` | 23.0154 | 14 |  |
| `generation.generation_p99_sec` | 30.9788 | 14 |  |
...
| `regression.current.retrieval_p50_sec` | 1.5339 | 15 | min=1.19s max=2.65s |
| `regression.current.retrieval_p95_sec` | 2.5259 | 15 |  |
| `regression.current.retrieval_p99_sec` | 2.6225 | 15 |  |
...
| `retrieval.retrieval_p50_sec` | 1.5058 | 15 | min=1.17s max=4.23s |
| `retrieval.retrieval_p95_sec` | 2.9418 | 15 |  |
| `retrieval.retrieval_p99_sec` | 3.9702 | 15 |  |
