        ...
        <div className="w-full max-w-[440px] rounded-2xl p-4 sm:p-10"
          ...
          {sent ? (
            ...
            <div className="text-center space-y-3 sm:space-y-4">
              ...
              <h2 className="text-lg sm:text-xl font-bold" style={{ color: 'var(--t-tx1)' }}>Check your inbox</h2>
              ...
              <button
                onClick={onBack}
                className="w-full flex items-center justify-center gap-2 font-semibold rounded-xl py-2.5 sm:py-3.5 text-sm sm:text-base transition-colors mt-2"
            ...
            <>
              <button
                onClick={onBack}
                className="flex items-center gap-1.5 text-sm mb-3 sm:mb-6 transition-opacity hover:opacity-70"
                style={{ color: 'var(--t-tx5)' }}
              >
                <ArrowLeft size={15} /> Back to sign in
              </button>

              <h2 className="text-lg sm:text-xl font-bold mb-1" style={{ color: 'var(--t-tx1)' }}>Forgot your password?</h2>
              <p className="text-xs sm:text-sm mb-4 sm:mb-7 leading-relaxed" style={{ color: 'var(--t-tx4)' }}>
